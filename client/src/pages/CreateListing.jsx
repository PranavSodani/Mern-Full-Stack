    ...
    <main className='mx-auto max-w-4xl'>
      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex  flex-col gap-4 flex-1'>
          <input type='text' placeholder='Name' className='border p-3 rounded-lg' maxLength='62' minLength='10' required id='name'/>
          ...
          <div className='flex flex-wrap gap-6'>
            <div className='flex items-center gap-2'>
              <input type="number" min='1' max='10' required id='bedrooms' className='p-3 border border-gray-300 rounded-lg'/>
              <p>Beds</p>
            </div>
            <div className='flex items-center gap-2'>
              <input type="number" min='1' max='10' required id='bathrooms' className='p-3 border border-gray-300 rounded-lg'/>
              <p>Baths</p>
            </div>
            <div className='flex items-center gap-2'>
              <input type="number" min='1' max='10' required id='regularPrice' className='p-3 border border-gray-300 rounded-lg'/>
